    ...
    container.innerHTML = items.map(p => `
      <div class="project-card-wrapper" data-id="${p.id}" data-category="${p.category}">
        <div class="project-card">
          <div class="card-thumb${p.thumbnailContain ? " thumb-contain" : p.thumbnailContainDark ? " thumb-contain-dark" : ""}">
  ...
  function renderProjectDetail(id) {
    ...
    section.innerHTML = `
      ...
      <div class="detail-hero">
        <div class="detail-thumb${p.thumbnailContain ? " thumb-contain" : p.thumbnailContainDark ? " thumb-contain-dark" : ""}">
          <img src="${p.thumbnail}" alt="${p.title}" onerror="this.parentElement.classList.add('no-thumb')">
